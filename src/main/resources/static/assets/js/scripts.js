                    ...
                    action: function (result, $this) {
                        if (result.result) {
                            ...
                            result.statistics.detailed.forEach(function (site) {
                                ...
                                $blockSiteExample.find('.Statistics-description').html('<div class="Statistics-option"><strong>Status time:</strong> ' +
                                    time.getDate() + '.' +
                                    (time.getMonth() + 1) + '.' +
                                    time.getFullYear() + ' ' +
                                    time.getHours() + ':' +
                                    ...
                                    '</div>' +
                                    (site.error !== null && site.error !== undefined ? '<div class="Statistics-option Statistics-option_error"><strong>Error:</strong> ' + site.error + '</div>' : '')
                                );

// Удалить элемент Statistics-option_error, если site.error отсутствует
                                if (site.error === null || site.error === undefined) {
                                    $blockSiteExample.find('.Statistics-option_error').remove();
                                }
